...
export default function ColumnScreen(): JSX.Element {
  return (
    <Section>
      ...
      <Text>
        {' '}
        Mobile force column to stay in one row on mobile device. In this case, narrow take the maximum width left.
      </Text>
